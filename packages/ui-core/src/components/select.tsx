  ...
  return (
    <div className={`relative inline-block ${className}`}>
      <select
        ...
        className="w-full appearance-none rounded-md border border-zinc-200 bg-white py-1.5 pl-3 pr-9 text-sm text-zinc-900 transition-colors focus:border-indigo-400 focus:outline-none focus:ring-1 focus:ring-indigo-400 disabled:cursor-not-allowed disabled:opacity-50 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100"
        {...props}
      >
        {placeholder && (
