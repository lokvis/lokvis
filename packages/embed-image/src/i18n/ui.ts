...
export const ui: Record<string, TranslationEntry> = {
  ...
  'common.dropHere': { en: '↓ Drop image', zh: '↓ 拖到这里', ja: '↓ 画像をドロップ', es: '↓ Suelta la imagen', de: '↓ Bild ablegen', fr: '↓ Déposez l\'image' },
  'common.noImage': { en: 'No image', zh: '暂无图片', ja: '画像なし', es: 'Sin imagen', de: 'Kein Bild', fr: 'Aucune image' },
  'common.ratioSaved': { en: 'Saved', zh: '已节省', ja: '削減', es: 'Ahorro', de: 'Gespart', fr: 'Économisé' },
  'common.ratioIncreased': { en: 'Increased', zh: '增加了', ja: '増加', es: 'Aumento', de: 'Zugenommen', fr: 'Augmenté' },
  'quickPipeline.emptySteps': { en: 'Pipeline steps will appear here after upload', zh: '上传后在此显示流水线步骤', ja: 'アップロード後にパイプラインのステップがここに表示されます', es: 'Los pasos del pipeline aparecerán aquí tras subir', de: 'Pipeline-Schritte erscheinen hier nach dem Upload', fr: 'Les étapes du pipeline apparaîtront ici après l\'envoi' },
