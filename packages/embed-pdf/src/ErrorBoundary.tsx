 ...
 *
 * 复用 @lokvis/embed-kit 的参数化工厂,注入 --lokvis-pdf-* 命名空间与
 * PdfI18nContext。以本包原有导出名 ErrorBoundary 再导出,Props 不变。
 *
...
import { PdfI18nContext } from './i18n/EmbedPdfI18nProvider';

export const ErrorBoundary = createEmbedErrorBoundary({
  cssPrefix: '--lokvis-pdf',
  i18nContext: PdfI18nContext,
  t,
  getLangFromUrl,
  captureException,
});
