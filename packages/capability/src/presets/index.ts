 ...
 *
 * 迁移状态(W4.3 + 问题 C 完成):
 * - image/pdf/video/audio/ai/developer:由 codegen 从 manifests/*.manifest.json 生成
 *   (见 packages/capability/manifests/),手写版本已删除
 * - asset:保留手写(无对应 plugin,无 operation entries)
