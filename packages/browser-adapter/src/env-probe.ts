/**
 * EnvProbe —— 浏览器能力探测(ADR-015)
 *
 * 自 runtime/src/browser-detect.ts(W22.3)整体迁入,并收编原散落在
 * runtime 各 store 的 isOpfsSupported / isIdbSupported。
 *
 ...
 * 3. 所有检测在 SSR(Node)环境下安全返回 false / unknown(环境安全约定)
