 ...
 *
 * 来源:packages/capability/manifests/ai.manifest.json, packages/capability/manifests/archive.manifest.json, packages/capability/manifests/audio.manifest.json, packages/capability/manifests/developer.manifest.json, packages/capability/manifests/image.manifest.json, packages/capability/manifests/pdf.manifest.json, packages/capability/manifests/video.manifest.json
 * 重跑:pnpm codegen
 *
