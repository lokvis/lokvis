/**
 * QuickI18nProvider — @lokvis/quick-image 的 i18n 注入入口(Task 2 解耦)。
 *
 * 设计动机:
 ...
 *   2. QuickI18nProvider 注入的 locale(app 级别)
 ...
 * 接入示例:
 * ```tsx
 * import { QuickI18nProvider, ImageQuickCompress } from '@lokvis/quick-image';
 *
...
export type QuickTranslations = Record<string, Partial<Record<Language, string>>>;
 ...
 */
export function QuickI18nProvider({
  locale,
  translations,
  children,
}: QuickI18nProviderProps) {
