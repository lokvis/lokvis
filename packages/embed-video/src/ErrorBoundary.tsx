 ...
 *
 * 复用 @lokvis/embed-kit 的参数化工厂,注入 --lokvis-video-* 命名空间与
 * VideoI18nContext。以本包原有导出名 ErrorBoundary 再导出,Props 不变。
 *
...
import { VideoI18nContext } from './i18n/EmbedVideoI18nProvider';

export const ErrorBoundary = createEmbedErrorBoundary({
  cssPrefix: '--lokvis-video',
  i18nContext: VideoI18nContext,
  t,
  getLangFromUrl,
  captureException,
});
