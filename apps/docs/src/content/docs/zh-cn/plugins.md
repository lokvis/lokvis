...
- `@lokvis/plugin-image` — 10 个图像能力(Canvas + createImageBitmap,真实实现)
- `@lokvis/plugin-video` — 7 个视频能力(ffmpeg.wasm 计划中,stub)
- `@lokvis/plugin-pdf` — 8 个 PDF 能力(pdf-lib 计划中,stub)
- `@lokvis/plugin-audio` — 4 个音频能力(Web Audio API + lamejs 计划中,stub)
- `@lokvis/plugin-ai` — 6 个 AI 能力(transformers + cloud-proxy 计划中,stub)
- `@lokvis/plugin-dev` — 9 个开发者工具(内置实现,真实实现)
