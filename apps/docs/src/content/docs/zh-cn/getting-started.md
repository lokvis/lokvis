...
本指南将带你完成 Lokvis 的安装、运行 playground,以及将 Runtime SDK 嵌入你自己的 Web 应用。
...
- [Plugin 开发](https://github.com/lokvis/lokvis/blob/dev/docs/plugins.md) — Plugin SDK 结构与 PluginContext API
